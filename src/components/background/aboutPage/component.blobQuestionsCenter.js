...
import { blob_Questions_Center } from '../../../styles/background/styles.aboutPage';

const BlobQuestionsAboutCenter = () => {
  return (
    <svg
      viewBox="0 0 200 200"
      xmlns="http://www.w3.org/2000/svg"
      className={blob_Questions_Center}>
      <path
        fill="#1bd7f033"
...
export default BlobQuestionsAboutCenter;
